...
class menu_item_obj
{
  ...
  // Constructor
  menu_item_obj(int menu_item_id, String menu_item, double item_price, int amount_in_stock, String type, List<String> ingredients)
  {
  ...
  String get_values()
  {
    return "${this.menu_item_id}, '${this.menu_item}', ${this.item_price}, ${this.amount_in_stock}, '${this.type}'";
  }
}